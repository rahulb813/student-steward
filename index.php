...
<body>
	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper" style="background-image: url(img/login-bg.jpg); height: 800px;">
					...
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-6 col-md-offset-3">
								<div class="well row pt-2x pb-3x bk-light" style="height: 350px; opacity: 0.8">
